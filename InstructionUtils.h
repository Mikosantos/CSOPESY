...
inline std::vector<Instruction> generateRandomInstructions(int targetCount) {
    ...
    while (actualCount < targetCount) {
        ...
        switch (type) {
            ...
            case 2: { // ADD (var1, var2/valaue, var3/value)
            ...
            case 3: { // SUBTRACT (var1, var2/valaue, var3/value) 
                        // var1 = var2/value - var3/value
...
inline std::vector<Instruction> generateFixedInstructions(int totalInstructions) {
    std::vector<Instruction> result;
